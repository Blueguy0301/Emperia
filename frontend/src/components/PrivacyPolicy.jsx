...
const PrivacyPolicy = () => {
  return (
    <div className="Privacy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Emperia.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Emperia, accessible from{' '}
            <a
              href="https://www.emperia.online"
      ...
      <ul>
        <li>By email: help.emperia@gmail.com</li>
      </ul>
    </div>
  )
}
